...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    material.DatePickerTheme? theme,
  }) async {
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? material.DatePickerTheme(),
  ...
  final material.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    material.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(material.DatePickerTheme theme) {
  ...
  Widget _renderItemView(material.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(material.DatePickerTheme theme) {
